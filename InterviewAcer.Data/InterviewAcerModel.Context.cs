...
namespace InterviewAcer.Data
{
    ...
    public partial class InterviewAcerDbContext : DbContext
    {
        ...
        public virtual ObjectResult<usp_GetCheckListDetailsForUser_Result> usp_GetCheckListDetailsForUser(string userId)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetCheckListDetailsForUser_Result>("usp_GetCheckListDetailsForUser", userIdParameter);
        }
    }
}
